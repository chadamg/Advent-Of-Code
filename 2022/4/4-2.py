...
range_overlap_evaluations = []
for [assignments_range1, assignments_range2] in assignments_ranges_pairs:
  range1 = set(assignments_range1)
  range2 = set(assignments_range2)
  overlap = range1 & range2
  if len(overlap):
    range_overlap_evaluations.append(1)
  else:
    range_overlap_evaluations.append(0)

print(sum(range_overlap_evaluations))